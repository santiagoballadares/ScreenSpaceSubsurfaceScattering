...
Mesh * Mesh::GenerateQuad(float texCoordScale)
{
    Mesh* m = new Mesh();
	...
	m->textureCoords[0] = Vector2(0.0f,			 texCoordScale);
    m->textureCoords[1] = Vector2(0.0f,			 0.0f);
    m->textureCoords[2] = Vector2(texCoordScale, texCoordScale);
    m->textureCoords[3] = Vector2(texCoordScale, 0.0f);
